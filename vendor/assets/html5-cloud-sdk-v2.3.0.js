...
root.Kii = (function() {
  ...
  Kii._listTopicsUsingCallbacks = function(callbacks, paginationKey, context) {
    ...
    listCallbacks = {
      success: function() {
        var j, json, len, ref, topic, topics;
...
root.KiiACL = (function() {
  function KiiACL() {
    this._thingWithID = bind(this._thingWithID, this);
    this._userWithID = bind(this._userWithID, this);
    this._groupWithID = bind(this._groupWithID, this);
    this._getRequest = bind(this._getRequest, this);
    this._saveItr = bind(this._saveItr, this);
    this._saveUsingCallbacks = bind(this._saveUsingCallbacks, this);
    this.save = bind(this.save, this);
    this._getKeyOfEntry = bind(this._getKeyOfEntry, this);
    this.removeACLEntry = bind(this.removeACLEntry, this);
    this.putACLEntry = bind(this.putACLEntry, this);
    this._listACLEntriesUsingCallbacks = bind(this._listACLEntriesUsingCallbacks, this);
    this.listACLEntries = bind(this.listACLEntries, this);
    this.aclPath = bind(this.aclPath, this);
    this._setParent = bind(this._setParent, this);
    this._entriesMap = {};
  }
    ...
    listCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          var action, entity, j, key, len, results, subject, value;
  ...
  KiiACL.prototype._saveItr = function(keys, idx, callbacks) {
    var _errorStr, aclEntry, path, request;
...
root.KiiACLAction = {
  ...
  KiiACLSubscribeToTopic: 5,
  KiiACLSendMessageToTopic: 6,
  KiiACLActionEnd: 7
};
...
root.KiiACLEntry = (function() {
  function KiiACLEntry() {
    this.getEntityString = bind(this.getEntityString, this);
    this.getActionString = bind(this.getActionString, this);
    this.getGrant = bind(this.getGrant, this);
    this.setGrant = bind(this.setGrant, this);
    this.getSubject = bind(this.getSubject, this);
    this.setSubject = bind(this.setSubject, this);
...
root.KiiBucket = (function() {
  ...
  KiiBucket.prototype._executeQueryUsingCallbacks = function(query, callbacks) {
    ...
    executeCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          var j, len, nextQuery, ref, result, resultSet;
          if (statusCode < 300 && statusCode >= 200) {
            resultSet = [];
            ref = data.results;
            for (j = 0, len = ref.length; j < len; j++) {
  ...
  function KiiBucket(bucketName, parent) {
    this.objectWithJSON = bind(this.objectWithJSON, this);
    this._getHttpUri = bind(this._getHttpUri, this);
    this._generatePath = bind(this._generatePath, this);
    this._getRequest = bind(this._getRequest, this);
    this._deleteUsingCallbacks = bind(this._deleteUsingCallbacks, this);
    this["delete"] = bind(this["delete"], this);
    this.count = bind(this.count, this);
    this._countWithQueryUsingCallbacks = bind(this._countWithQueryUsingCallbacks, this);
    this.countWithQuery = bind(this.countWithQuery, this);
    this._executeQueryUsingCallbacks = bind(this._executeQueryUsingCallbacks, this);
    this.executeQuery = bind(this.executeQuery, this);
    this.acl = bind(this.acl, this);
    this.createObjectWithID = bind(this.createObjectWithID, this);
    this.createObjectWithType = bind(this.createObjectWithType, this);
    this.createObject = bind(this.createObject, this);
    this._getQualifiedBucketName = bind(this._getQualifiedBucketName, this);
    this._setBucketName = bind(this._setBucketName, this);
    this.getBucketName = bind(this.getBucketName, this);
    this.getThing = bind(this.getThing, this);
...
root.KiiEncryptedBucket = (function(superClass) {
  extend(KiiEncryptedBucket, superClass);
...
root.KiiEncryptedBucketAdmin = (function(superClass) {
  extend(KiiEncryptedBucketAdmin, superClass);
...
root.KiiBucketAdmin = (function(superClass) {
  extend(KiiBucketAdmin, superClass);
...
root.KiiGroup = (function() {
  ...
  function KiiGroup() {
    this._setAuthToken = bind(this._setAuthToken, this);
    this._getHttpURI = bind(this._getHttpURI, this);
    this._listTopicsUsingCallbacks = bind(this._listTopicsUsingCallbacks, this);
    this.listTopics = bind(this.listTopics, this);
    this.topicWithName = bind(this.topicWithName, this);
    this._setOwnerFromContext = bind(this._setOwnerFromContext, this);
    this._userWithID = bind(this._userWithID, this);
    this._getRequest = bind(this._getRequest, this);
    this._updateWithJSON = bind(this._updateWithJSON, this);
    this._getOwnerUsingCallbacks = bind(this._getOwnerUsingCallbacks, this);
    this.getOwner = bind(this.getOwner, this);
    this._deleteUsingCallbacks = bind(this._deleteUsingCallbacks, this);
    this["delete"] = bind(this["delete"], this);
    this._refreshUsingCallbacks = bind(this._refreshUsingCallbacks, this);
    this.refresh = bind(this.refresh, this);
    this._saveUsingCallbacks = bind(this._saveUsingCallbacks, this);
    this.save = bind(this.save, this);
    this._changeGroupNameUsingCallbacks = bind(this._changeGroupNameUsingCallbacks, this);
    this.changeGroupName = bind(this.changeGroupName, this);
    this._saveMembers = bind(this._saveMembers, this);
    this._getMemberListUsingCallbacks = bind(this._getMemberListUsingCallbacks, this);
    this.getMemberList = bind(this.getMemberList, this);
    this._removeMember = bind(this._removeMember, this);
    this._addMember = bind(this._addMember, this);
    this.removeUser = bind(this.removeUser, this);
    this.addUser = bind(this.addUser, this);
    this.encryptedBucketWithName = bind(this.encryptedBucketWithName, this);
    this.bucketWithName = bind(this.bucketWithName, this);
    this.objectURI = bind(this.objectURI, this);
    this._setOwner = bind(this._setOwner, this);
    this.getCachedOwner = bind(this.getCachedOwner, this);
    this._setName = bind(this._setName, this);
    this.getName = bind(this.getName, this);
    this.getID = bind(this.getID, this);
    this._setUUID = bind(this._setUUID, this);
    this.getUUID = bind(this.getUUID, this);
    this._setAddMembers = bind(this._setAddMembers, this);
    this._getRemoveMembers = bind(this._getRemoveMembers, this);
    this._getAddMembers = bind(this._getAddMembers, this);
    this._addMembers = {};
    this._removeMembers = {};
  }

  KiiGroup.prototype._setAddMembers = function(members) {
    var j, len, member, results1;
    if (members != null) {
      results1 = [];
      for (j = 0, len = members.length; j < len; j++) {
        member = members[j];
        results1.push(this.addUser(member));
      }
      return results1;
    }
  };
      ...
      failure: (function(_this) {
        return function(error, statusCode) {
          ...
          addMembersArray = (function() {
            var ref, results1;
            ref = this._addMembers;
            results1 = [];
            for (userID in ref) {
              member = ref[userID];
              results1.push(member);
            }
            return results1;
          }).call(_this);
          removeMembersArray = (function() {
            var ref, results1;
            ref = this._removeMembers;
            results1 = [];
            for (userID in ref) {
              member = ref[userID];
              results1.push(member);
  ...
  KiiGroup.prototype._getMemberListUsingCallbacks = function(callbacks) {
    ...
    listCallbacks = {
      success: (function(_this) {
        return function(data, statusCode) {
          var j, len, member, memberList, members;
          if (statusCode < 300 && statusCode >= 200) {
            memberList = [];
...
root.KiiObject = (function() {
  ...
  function KiiObject() {
    this._deleteBodyUsingCallbacks = bind(this._deleteBodyUsingCallbacks, this);
    this.deleteBody = bind(this.deleteBody, this);
    this._publishBodyExpiresInUsingCallbacks = bind(this._publishBodyExpiresInUsingCallbacks, this);
    this.publishBodyExpiresIn = bind(this.publishBodyExpiresIn, this);
    this._publishBodyExpiresAtUsingCallbacks = bind(this._publishBodyExpiresAtUsingCallbacks, this);
    this.publishBodyExpiresAt = bind(this.publishBodyExpiresAt, this);
    this._publishBodyUsingCallbacks = bind(this._publishBodyUsingCallbacks, this);
    this.publishBody = bind(this.publishBody, this);
    this._downloadBodyUsingCallbacks = bind(this._downloadBodyUsingCallbacks, this);
    this.downloadBody = bind(this.downloadBody, this);
    this._uploadBodyUsingCallbacks = bind(this._uploadBodyUsingCallbacks, this);
    this.uploadBody = bind(this.uploadBody, this);
    this._moveBodyUsingCallbacks = bind(this._moveBodyUsingCallbacks, this);
    this.moveBody = bind(this.moveBody, this);
    this._parseObjectUri = bind(this._parseObjectUri, this);
    this._userWithID = bind(this._userWithID, this);
    this._setAuthorizationHeader = bind(this._setAuthorizationHeader, this);
    this._getToken = bind(this._getToken, this);
    this._getRequest = bind(this._getRequest, this);
    this._setETag = bind(this._setETag, this);
    this._deleteUsingCallbacks = bind(this._deleteUsingCallbacks, this);
    this["delete"] = bind(this["delete"], this);
    this._refreshUsingCallbacks = bind(this._refreshUsingCallbacks, this);
    this.refresh = bind(this.refresh, this);
    this._saveUsingCallbacks = bind(this._saveUsingCallbacks, this);
    this.save = bind(this.save, this);
    this._saveAllFieldsUsingCallbacks = bind(this._saveAllFieldsUsingCallbacks, this);
    this.saveAllFields = bind(this.saveAllFields, this);
    this._performUpdate = bind(this._performUpdate, this);
    this._performSave = bind(this._performSave, this);
    this._updateWithJSON = bind(this._updateWithJSON, this);
    this.objectURI = bind(this.objectURI, this);
    this.objectACL = bind(this.objectACL, this);
    this.getGeoPoint = bind(this.getGeoPoint, this);
    this.setGeoPoint = bind(this.setGeoPoint, this);
    this.get = bind(this.get, this);
    this.set = bind(this.set, this);
    this._getPath = bind(this._getPath, this);
    this._setBodyContentType = bind(this._setBodyContentType, this);
    this.getBodyContentType = bind(this.getBodyContentType, this);
    this._setBucket = bind(this._setBucket, this);
    this.getBucket = bind(this.getBucket, this);
    this._setObjectType = bind(this._setObjectType, this);
    this.getObjectType = bind(this.getObjectType, this);
    this._setModified = bind(this._setModified, this);
    this.getModified = bind(this.getModified, this);
    this._setCreated = bind(this._setCreated, this);
    this.getCreated = bind(this.getCreated, this);
    this._setUUID = bind(this._setUUID, this);
    this.getUUID = bind(this.getUUID, this);
    this._customInfo = {};
    this._alteredFields = [];
    ...
    for (key in json) {
      ...
      if (key === "_id") {
        if (this._uuid == null) {
          ...
          results1.push(this._uuid = val);
        } else {
          results1.push(void 0);
        }
      } else if (key === "createdAt" || key === "_created" || key === "created") {
        results1.push(this._created = val);
      } else if (key === "modifiedAt" || key === "_modified" || key === "modified") {
        results1.push(this._modified = val);
      } else if (key === "_owner") {
        results1.push(this._owner = this._userWithID(val));
      } else if (key === "_dataType") {
        results1.push(this._objectType = val);
      } else if (key === "_calculated") {
        results1.push(this._customInfo[key] = val);
      } else if (key[0] !== "_") {
        results1.push(this._customInfo[key] = val);
      } else if (key === "_version") {
        results1.push(this._etag = val);
      } else {
        results1.push(void 0);
      }
    }
  ...
  KiiObject.prototype._performUpdate = function(patch, callbacks, overwrite) {
    var data, isSaved, j, key, len, path, ref, request, updateCallbacks;
    path = this._getPath();
    request = new this._getRequest({
      path: path,
      withApp: true
  ...
  KiiObject.prototype._moveBodyUsingCallbacks = function(targetObjectUri, callbacks) {
    var error1, errorMessage, moveCallbacks, path, request;
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        uploadBodyCallbacks = {
          ...
          progress: function() {
            var ref;
            return callbacks != null ? (ref = callbacks.progress) != null ? ref.apply(callbacks, arguments) : void 0 : void 0;
          }
        };
...
root.KiiQuery = (function() {
  function KiiQuery(query) {
    this._dictValue = bind(this._dictValue, this);
    this.sortByAsc = bind(this.sortByAsc, this);
    this.sortByDesc = bind(this.sortByDesc, this);
    this.setLimit = bind(this.setLimit, this);
    this.getLimit = bind(this.getLimit, this);
    this._setClause = bind(this._setClause, this);
    this.setPaginationKey = bind(this.setPaginationKey, this);
    this.getPaginationKey = bind(this.getPaginationKey, this);
...
root.KiiClause = (function() {
  function KiiClause() {
    this._getDictValue = bind(this._getDictValue, this);
    this._setDictValue = bind(this._setDictValue, this);
    this._setWhereClauses = bind(this._setWhereClauses, this);
    this._setWhereType = bind(this._setWhereType, this);
  }
  ...
  KiiClause.prototype._getDictValue = function() {
    var clause, clauses, j, len, ref, retDict;
    retDict = {};
  ...
  KiiClause.geoDistance = function(key, center, radius, putDistanceInto) {
    var _dict, expression, isValidGeoPoint, isValidString, pattern;
  ...
  KiiClause.geoBox = function(key, northEast, southWest) {
    var _dict, expression, isValidGeoPoint, isValidKey, ne, sw;
...
KiiRequest = (function() {
  ...
  function KiiRequest(path, withApp) {
    ...
    this.setAdminToken = bind(this.setAdminToken, this);
    this.addHeader = bind(this.addHeader, this);
    this.setAccept = bind(this.setAccept, this);
    this.getAccept = bind(this.getAccept, this);
    this.setAnonymous = bind(this.setAnonymous, this);
    this.isAnonymous = bind(this.isAnonymous, this);
    this.setContentType = bind(this.setContentType, this);
    this.getContentType = bind(this.getContentType, this);
  ...
  KiiRequest.prototype.execute = function(callbacks, ignoreBody) {
    var h, key, name, ref, sendData, url, value;
    ...
    callbacks = {
      onComplete: (function(_this) {
        return function() {
          var e, errString, error, error1, error2, json, ref, responseHeaders, xhr;
          xhr = _this._httpRequest.xhr;
          if (xhr.readyState === 4) {
            if ((200 <= (ref = xhr.status) && ref < 400)) {
      ...
      onError: (function(_this) {
        return function() {
          var errString, error, error1, json, xhr;
          xhr = _this._httpRequest.xhr;
          root.Kii.logger('Error loading data...');
          errString = xhr.status + " : " + root.Kii.getBaseURL() + _this._path;
          try {
...
root.KiiUser = (function() {
  function KiiUser() {
    ...
    this._getHttpURI = bind(this._getHttpURI, this);
    this._clone = bind(this._clone, this);
    this._getSubscriberPath = bind(this._getSubscriberPath, this);
    this.pushSubscription = bind(this.pushSubscription, this);
    this._listTopicsUsingCallbacks = bind(this._listTopicsUsingCallbacks, this);
    this.listTopics = bind(this.listTopics, this);
    this.topicWithName = bind(this.topicWithName, this);
    this._groupWithJSON = bind(this._groupWithJSON, this);
    this._setAuthHeader = bind(this._setAuthHeader, this);
    this._getXhrWrapper = bind(this._getXhrWrapper, this);
    this._getRequest = bind(this._getRequest, this);
    this._updateWithJSON = bind(this._updateWithJSON, this);
    this._validateLocalPhoneNumber = bind(this._validateLocalPhoneNumber, this);
    this._validateIdentityData = bind(this._validateIdentityData, this);
    this._updateWithUserFields = bind(this._updateWithUserFields, this);
    this._updateWithIdentityData = bind(this._updateWithIdentityData, this);
    this._deleteUsingCallbacks = bind(this._deleteUsingCallbacks, this);
    this["delete"] = bind(this["delete"], this);
    this._refreshUsingCallbacks = bind(this._refreshUsingCallbacks, this);
    this.refresh = bind(this.refresh, this);
    this._saveUsingCallbacks = bind(this._saveUsingCallbacks, this);
    this.save = bind(this.save, this);
    this._changeEmailUsingCallbacks = bind(this._changeEmailUsingCallbacks, this);
    this.changeEmail = bind(this.changeEmail, this);
    this._changePhoneUsingCallbacks = bind(this._changePhoneUsingCallbacks, this);
    this.changePhone = bind(this.changePhone, this);
    this._ownerOfGroupsUsingCallbacks = bind(this._ownerOfGroupsUsingCallbacks, this);
    this.ownerOfGroups = bind(this.ownerOfGroups, this);
    this._memberOfGroupsUsingCallbacks = bind(this._memberOfGroupsUsingCallbacks, this);
    this.memberOfGroups = bind(this.memberOfGroups, this);
    this.resendPhoneNumberVerification = bind(this.resendPhoneNumberVerification, this);
    this.resendEmailVerification = bind(this.resendEmailVerification, this);
    this._resendVerificationUsingCallbacks = bind(this._resendVerificationUsingCallbacks, this);
    this.resendVerification = bind(this.resendVerification, this);
    this.verifyPhoneNumber = bind(this.verifyPhoneNumber, this);
    this._verifyCredentialsUsingCallbacks = bind(this._verifyCredentialsUsingCallbacks, this);
    this.verifyCredentials = bind(this.verifyCredentials, this);
    this._updatePasswordUsingCallbacks = bind(this._updatePasswordUsingCallbacks, this);
    this.updatePassword = bind(this.updatePassword, this);
    this._updateUsingCallbacks = bind(this._updateUsingCallbacks, this);
    this.update = bind(this.update, this);
    this._putIdentityUsingCallbacks = bind(this._putIdentityUsingCallbacks, this);
    this.putIdentity = bind(this.putIdentity, this);
    this._registerUsingCallbacks = bind(this._registerUsingCallbacks, this);
    this.register = bind(this.register, this);
    this._authenticateWithToken = bind(this._authenticateWithToken, this);
    ...
    this.set = bind(this.set, this);
    this.objectURI = bind(this.objectURI, this);
    this.getAccessTokenObject = bind(this.getAccessTokenObject, this);
    this._setExpiresAt = bind(this._setExpiresAt, this);
    this._setAccessToken = bind(this._setAccessToken, this);
    this.getAccessToken = bind(this.getAccessToken, this);
    this.getLinkedSocialAccounts = bind(this.getLinkedSocialAccounts, this);
    this._setPhoneVerified = bind(this._setPhoneVerified, this);
    this.getPhoneVerified = bind(this.getPhoneVerified, this);
    this._setEmailVerified = bind(this._setEmailVerified, this);
    this.getEmailVerified = bind(this.getEmailVerified, this);
    this._setModified = bind(this._setModified, this);
    this.getModified = bind(this.getModified, this);
    this._setCreated = bind(this._setCreated, this);
    this.getCreated = bind(this.getCreated, this);
    ...
    this._clearPassword = bind(this._clearPassword, this);
    this._setPassword = bind(this._setPassword, this);
    this._setPhoneNumber = bind(this._setPhoneNumber, this);
    this.getPhoneNumber = bind(this.getPhoneNumber, this);
    this._setEmailAddress = bind(this._setEmailAddress, this);
    this.getEmailAddress = bind(this.getEmailAddress, this);
    this.isPseudoUser = bind(this.isPseudoUser, this);
    this.setDisplayName = bind(this.setDisplayName, this);
    this.getDisplayName = bind(this.getDisplayName, this);
    this._setDisabled = bind(this._setDisabled, this);
    this.disabled = bind(this.disabled, this);
    this._setUsername = bind(this._setUsername, this);
  ...
  KiiUser.prototype._registerUsingCallbacks = function(callbacks) {
    var data, key, ref, registrationCallbacks, request, value;
  ...
  KiiUser._registerAsPseudoUserUsingCallbacks = function(callbacks, userFields) {
    ...
    requestCallbacks = {
      success: function() {
        var accessToken, errString, error1, json, user;
        try {
  ...
  KiiUser.prototype._putIdentityUsingCallbacks = function(identityData, password, callbacks, userFields, removeFields) {
    var country, data, error1, errorString, hasIdentityData;
    ...
    return this.refresh({
      ...
      success: (function(_this) {
        return function(user) {
          var j, jsonBody, key, len, removeField, requestCallbacks, url, value, wrapper, xhr;
          ...
          if (removeFields != null) {
            for (j = 0, len = removeFields.length; j < len; j++) {
  ...
  KiiUser.prototype._updateUsingCallbacks = function(identityData, callbacks, userFields, removeFields) {
    var country, data, error1, errorString, hasIdentityData, hasRemoveFields, hasUserFields, j, key, len, removeField, value;
    ...
    return this.refresh({
      ...
      success: (function(_this) {
        return function(user) {
          var jsonBody, l, len1, requestCallbacks, url, wrapper, xhr;
          ...
          if (removeFields != null) {
            for (l = 0, len1 = removeFields.length; l < len1; l++) {
              removeField = removeFields[l];
              delete data[removeField];
            }
          }
          url = root.Kii.getBaseURL() + "/apps/" + root.Kii.getAppID() + ("/users/" + _this._uuid);
  ...
  KiiUser.prototype._updateWithUserFields = function(userFields, removeFields) {
    var j, key, len, removeField, results1, value;
    if (userFields != null) {
      for (key in userFields) {
        value = userFields[key];
        if (key === "displayName") {
    ...
    if (removeFields != null) {
      ...
      for (j = 0, len = removeFields.length; j < len; j++) {
        removeField = removeFields[j];
        results1.push(delete this._customInfo[removeField]);
      }
      return results1;
    }
  };
  ...
  KiiUser.prototype._updateWithJSON = function(json) {
    ...
    for (key in json) {
      ...
      if (key === "userID" || key === "id") {
        results1.push(this._uuid = value);
      } else if (key === "created" || key === "createdAt" || key === "_created") {
        results1.push(this._created = value);
      } else if (key === "modified" || key === "modifiedAt" || key === "_modified") {
        results1.push(this._modified = value);
      } else if (key === "loginName") {
        results1.push(this._username = value);
      } else if (key === "displayName") {
        results1.push(this._displayName = value);
      } else if (key === "country") {
        root.Kii.logger("Is setting country");
        results1.push(this._country = value);
      } else if (key === "emailAddress") {
        results1.push(this._emailAddress = value);
      } else if (key === "phoneNumber") {
        results1.push(this._phoneNumber = value);
      } else if (key === "emailAddressVerified") {
        root.Kii.logger("Email verified: " + value);
        results1.push(this._emailVerified = value);
      } else if (key === "phoneNumberVerified") {
        root.Kii.logger("Phone verified: " + value);
        results1.push(this._phoneVerified = value);
      } else if (key === "_hasPassword") {
        root.Kii.logger("_hasPassword: " + value);
        results1.push(this._hasPassword = value);
        ...
        results1.push(this._thirdPartyAccounts = value);
      } else if (key === "_disabled") {
        root.Kii.logger("disabled: " + value);
        results1.push(this._disabled = value);
      } else if (key === "") {
        root.Kii.logger("Setting empty to custom info");
        results1.push(this._customInfo[key] = value);
      } else if (key.substring(0, 1 !== "_")) {
        root.Kii.logger("Setting to custom info");
        results1.push(this._customInfo[key] = value);
      } else {
        results1.push(root.Kii.logger("Doing nothing"));
      }
    }
    return results1;
  };
...
KiiUtilities = (function() {
  ...
  KiiUtilities._validateDisplayName = function(value) {
    var ref;
    return KiiUtilities._type(value) === "string" && (1 <= (ref = value.length) && ref <= 50);
  };
  ...
  KiiUtilities._safeCalculateExpiresAtAsNumber = function(expirationInSeconds, baseUnixTimeInMills) {
    var e, error1, expirationInMillis, expiresAt;
    expiresAt = 0;
    try {
...
root.KiiSocialConnect = (function() {
  ...
  KiiSocialConnect.logIn = function(networkName, options, callbacks) {
    ...
    return new Promise(function(resolve, reject) {
      var error, error1, errorString, logInCallbacks;
      logInCallbacks = {
        success: function() {
          if (callbacks != null) {
            callbacks.success.apply(callbacks, arguments);
  ...
  KiiSocialConnect.linkCurrentUserWithNetwork = function(networkName, options, callbacks) {
    ...
    return new Promise(function(resolve, reject) {
      var currentUser, error, error1, errorString, linkCurrentUserWithNetworkCallbacks;
...
_KiiSocialConnect = (function() {
  function _KiiSocialConnect() {
    this._getManager = bind(this._getManager, this);
  }
...
root.KiiSocialConnectNetwork = (function() {
  ...
  function KiiSocialConnectNetwork(_network) {
    ...
    this._getAccessToken = bind(this._getAccessToken, this);
    this._createTokenObject = bind(this._createTokenObject, this);
    this._unlinkFromCurrentUser = bind(this._unlinkFromCurrentUser, this);
    this._linkWithCurrentUser = bind(this._linkWithCurrentUser, this);
    this._logOut = bind(this._logOut, this);
    this._logIn = bind(this._logIn, this);
    this._isAuthenticated = bind(this._isAuthenticated, this);
    this._getTokenObject = bind(this._getTokenObject, this);
    this._setTokenObject = bind(this._setTokenObject, this);
    this._getTokenExpiration = bind(this._getTokenExpiration, this);
    this._setTokenExpiration = bind(this._setTokenExpiration, this);
    this._getToken = bind(this._getToken, this);
    this._setToken = bind(this._setToken, this);
    this._getNetwork = bind(this._getNetwork, this);
    this._setNetwork = bind(this._setNetwork, this);
...
root.KiiSCNFacebook = (function(superClass) {
  extend(KiiSCNFacebook, superClass);
...
root.KiiAppAdminContext = (function() {
  function KiiAppAdminContext(spec) {
    this.listTopics = bind(this.listTopics, this);
    this.topicWithName = bind(this.topicWithName, this);
    this.loadThingWithThingID = bind(this.loadThingWithThingID, this);
    this.loadThingWithVendorThingID = bind(this.loadThingWithVendorThingID, this);
    this.registerOwnerWithVendorThingID = bind(this.registerOwnerWithVendorThingID, this);
    this.registerOwnerWithThingID = bind(this.registerOwnerWithThingID, this);
    this.thingWithID = bind(this.thingWithID, this);
    this.registerThing = bind(this.registerThing, this);
    this._getToken = bind(this._getToken, this);
    this._getId = bind(this._getId, this);
    this._objectWithURI = bind(this._objectWithURI, this);
  ...
  KiiAppAdminContext.prototype._objectWithURI = function(objectUri) {
    ...
    if (compLength >= 4 && valid) {
      ...
      if (components[0] === "groups" && compLength === 6) {
        subject = new root.KiiGroupAdmin._groupWithID(components[1], this._token);
      } else if (components[0] === "users" && compLength === 6) {
        subject = root.KiiUserAdmin._userWithID(components[1], this._token);
      } else if (components[0] === "things" && compLength === 6) {
        subject = root.KiiThingAdmin.thingWithID(components[1], this._token);
  ...
  KiiAppAdminContext.prototype.registerThing = function(fields, callbacks) {
    return root.KiiThingAdmin.register(fields, callbacks, this._token);
  };
  ...
  KiiAppAdminContext.prototype.thingWithID = function(thingID) {
    return root.KiiThingAdmin.thingWithID(thingID, this._token);
  };
  ...
  KiiAppAdminContext.prototype.registerOwnerWithThingID = function(thingID, owner, callbacks) {
    return root.KiiThingAdmin.registerOwnerWithThingID(thingID, owner, callbacks, this._token);
  };
  ...
  @param {String} The vendor thing ID of thing
  @param {KiiUser or KiiGroup} owner to be registered as owner.
  @param {Object} [callbacks] object holds callback functions.
  @param {Function} callbacks.success callback called when operation succeeded.
  <br>1st argument: user/group object registered as owner.
  ...
  KiiAppAdminContext.prototype.registerOwnerWithVendorThingID = function(vendorThingID, owner, callbacks) {
    return root.KiiThingAdmin.registerOwnerWithVendorThingID(vendorThingID, owner, callbacks, this._token);
  };
  ...
  KiiAppAdminContext.prototype.loadThingWithVendorThingID = function(vendorThingID, callbacks) {
    return root.KiiThingAdmin.loadWithVendorThingID(vendorThingID, callbacks, this._token);
  };
  ...
  KiiAppAdminContext.prototype.loadThingWithThingID = function(thingID, callbacks) {
    return root.KiiThingAdmin.loadWithThingID(thingID, callbacks, this._token);
  };
  ...
  KiiAppAdminContext.prototype.topicWithName = function(topicName) {
    ...
    return new root.KiiTopicAdmin((root.Kii.getBaseURL()) + "/apps/" + (root.Kii.getAppID()), topicName, this._token);
  };
...
root.KiiACLAdmin = (function(superClass) {
  extend(KiiACLAdmin, superClass);
...
root.KiiGroupAdmin = (function(superClass) {
  extend(KiiGroupAdmin, superClass);
  ...
  KiiGroupAdmin.prototype._setAuthToken = function(wrapper) {
    return wrapper.setAuthToken(this._adminToken);
  };

  KiiGroupAdmin.prototype.topicWithName = function(topicName) {
    var id, puri;
    if (typeof topicName !== "string" || topicName === "") {
      throw new root.InvalidArgumentException('topicName should not null or empty');
    }
    ...
    puri = this._getHttpURI();
    return new root.KiiTopicAdmin(puri, topicName, this._adminToken);
  };
...
root.KiiObjectAdmin = (function(superClass) {
  extend(KiiObjectAdmin, superClass);
...
root.KiiUserAdmin = (function(superClass) {
  extend(KiiUserAdmin, superClass);
  ...
  KiiUserAdmin.prototype._setAuthToken = function(wrapper) {
    return wrapper.setAuthToken(this._adminToken);
  };
  ...
  KiiUserAdmin.prototype.pushSubscription = function() {
    return new root.KiiPushSubscriptionAdmin(this, this._adminToken);
  };

  KiiUserAdmin.prototype.topicWithName = function(topicName) {
    var id;
    if (typeof topicName !== "string" || topicName === "") {
      throw new root.InvalidArgumentException('topicName should not null or empty');
    }
    ...
    return new root.KiiTopicAdmin(this._getHttpURI(), topicName, this._adminToken);
  };
...
root.KiiSCNTwitter = (function(superClass) {
  extend(KiiSCNTwitter, superClass);
...
root.KiiGeoPoint = (function() {
  function KiiGeoPoint(_latitude, _longitude) {
    ...
    this._toDict = bind(this._toDict, this);
    this.getLongitude = bind(this.getLongitude, this);
    this.getLatitude = bind(this.getLatitude, this);
...
KiiXHRWrapper = (function() {
  ...
  function KiiXHRWrapper(method, url) {
    this.setAuthToken = bind(this.setAuthToken, this);
    this.setAdminOrUserToken = bind(this.setAdminOrUserToken, this);
    this.setCurrentUserToken = bind(this.setCurrentUserToken, this);
    this.setContentType = bind(this.setContentType, this);
    this.setKiiHeaders = bind(this.setKiiHeaders, this);
    this.getErrorCode = bind(this.getErrorCode, this);
    this.getErrorString = bind(this.getErrorString, this);
    this.sendData = bind(this.sendData, this);
    this.send = bind(this.send, this);
    this._setUpCallbacks = bind(this._setUpCallbacks, this);
    var hs, k, v;
    url = KiiUtilities._disableCacheURL(url);
    this.xhr = new XMLHttpRequest;
    this.method = method;
      ...
      onComplete: (function(_this) {
        return function() {
          ...
          if (_this.xhr.readyState === 4) {
            if ((200 <= (ref = _this.xhr.status) && ref < 400)) {
  ...
  KiiXHRWrapper.prototype.setCurrentUserToken = function() {
    var ref, token;
    token = (ref = this.getCurrentUser()) != null ? ref.getAccessToken() : void 0;
    if (token != null) {
...
KiiTiXHRWrapper = (function(superClass) {
  extend(KiiTiXHRWrapper, superClass);
...
KiiJQXHRWrapper = (function(superClass) {
  extend(KiiJQXHRWrapper, superClass);
...
root.KiiSCNQQ = (function(superClass) {
  extend(KiiSCNQQ, superClass);
...
root.KiiServerCodeEntry = (function() {
  function KiiServerCodeEntry(entryName1, version1) {
    this.entryName = entryName1;
  ...
  KiiServerCodeEntry.prototype._executeUsingCallbacks = function(argument, callbacks) {
    var jsonBody, ref, requestData, serverCodeExecutionCallBacks, url, versionName, wrapper, xhr;
    ...
    versionName = (ref = this.version) != null ? ref : "current";
    ...
    serverCodeExecutionCallBacks = {
      success: (function(_this) {
        return function() {
          var error1, errorString, execResult, returnObject, stepCount;
      ...
      failure: (function(_this) {
        return function() {
          var error1, errorMessage, errorString, json, stepCount;
          stepCount = xhr.getResponseHeader("X-Step-count");
          errorMessage = {
            statusCode: xhr.status,
...
root.KiiServerCodeExecResult = (function() {
  function KiiServerCodeExecResult(returnObject1, exeSteps) {
    this.returnObject = returnObject1;
...
root.KiiThing = (function() {
  function KiiThing(fields1) {
    ...
    this.encryptedBucketWithName = bind(this.encryptedBucketWithName, this);
    this.bucketWithName = bind(this.bucketWithName, this);
    this._changeStatus = bind(this._changeStatus, this);
    this.enable = bind(this.enable, this);
    this.disable = bind(this.disable, this);
    this.unregisterOwner = bind(this.unregisterOwner, this);
    this._getOwnerURL = bind(this._getOwnerURL, this);
    this.registerOwner = bind(this.registerOwner, this);
    this.isOwner = bind(this.isOwner, this);
    this.deleteThing = bind(this.deleteThing, this);
    this.update = bind(this.update, this);
    this._refresh = bind(this._refresh, this);
    this.refresh = bind(this.refresh, this);
    this.getDisabled = bind(this.getDisabled, this);
    this.getCreated = bind(this.getCreated, this);
    this.getAccessToken = bind(this.getAccessToken, this);
    this.getVendorThingID = bind(this.getVendorThingID, this);
    this.getThingID = bind(this.getThingID, this);
    this._renewThingFields = bind(this._renewThingFields, this);
    if (this.fields != null) {
  ...
  KiiThing.prototype.update = function(callbacks) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        _refreshCallbacks = {
          success: function(respJson) {
            var k, ref, sendCallbacks, v, wrapper;
            ref = _this.fields;
            for (k in ref) {
              v = ref[k];
              respJson[k] = v;
  ...
  KiiThing.prototype.isOwner = function(owner, callbacks) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        var errObj, error1, message, ownerUrl, sendCallbacks, wrapper;
        try {
...
root.KiiTopic = (function() {
  function KiiTopic(parentUri, topicName) {
    ...
    this._setAuthToken = bind(this._setAuthToken, this);
    this.acl = bind(this.acl, this);
    this.deleteTopic = bind(this.deleteTopic, this);
...
root.KiiPushMessageBuilder = (function() {
   ...
   */
  function KiiPushMessageBuilder(data1) {
    this.data = data1;
    this.mqttData = bind(this.mqttData, this);
    this.jpushData = bind(this.jpushData, this);
    this.apnsCategory = bind(this.apnsCategory, this);
    this.apnsContentAvailable = bind(this.apnsContentAvailable, this);
    this.apnsBadge = bind(this.apnsBadge, this);
    this.apnsSound = bind(this.apnsSound, this);
    this.apnsAlert = bind(this.apnsAlert, this);
    this.apnsData = bind(this.apnsData, this);
    this.gcmRestrictedPackageName = bind(this.gcmRestrictedPackageName, this);
    this.gcmTimeToLive = bind(this.gcmTimeToLive, this);
    this.gcmDelayWhileIdle = bind(this.gcmDelayWhileIdle, this);
    this.gcmCollapseKey = bind(this.gcmCollapseKey, this);
    this.gcmData = bind(this.gcmData, this);
    this.enableMqtt = bind(this.enableMqtt, this);
    this.enableJpush = bind(this.enableJpush, this);
    this.enableApns = bind(this.enableApns, this);
    this.enableGcm = bind(this.enableGcm, this);
    this.setSendToProduction = bind(this.setSendToProduction, this);
    this.setSendToDevelopment = bind(this.setSendToDevelopment, this);
...
root.KiiPushSubscription = (function() {
  ...
  function KiiPushSubscription(_subscriber) {
    ...
    this._setAuthToken = bind(this._setAuthToken, this);
    this._getRequestHTTPURI = bind(this._getRequestHTTPURI, this);
    this._validateTarget = bind(this._validateTarget, this);
    this.isSubscribed = bind(this.isSubscribed, this);
...
root.KiiThingAdmin = (function(superClass) {
  extend(KiiThingAdmin, superClass);

  function KiiThingAdmin(fields, thingID, vendorThingID, _adminToken) {
    this._adminToken = _adminToken;
    this.topicWithName = bind(this.topicWithName, this);
    this.bucketWithName = bind(this.bucketWithName, this);
    this.pushSubscription = bind(this.pushSubscription, this);
    this._setAuthToken = bind(this._setAuthToken, this);
    KiiThingAdmin.__super__.constructor.call(this, fields);
    if (thingID != null) {
  ...
  KiiThingAdmin.register = function(fields, callbacks, accessToken) {
    return new Promise(function(resolve, reject) {
      var sendCallbacks, wrapper;
      wrapper = KiiXHRWrapperFactory.createXHRWrapper('POST', (root.Kii.getBaseURL()) + "/apps/" + (root.Kii.getAppID()) + "/things");
      wrapper.setKiiHeaders();
      ...
      sendCallbacks = {
        success: function() {
          var respJson, thing;
          respJson = JSON.parse(decodeURIComponent(wrapper.xhr.responseText));
          thing = new root.KiiThingAdmin(respJson, null, null, accessToken);
          if (callbacks != null) {
            callbacks.success(thing);
          }
          return resolve(thing);
  ...
  KiiThingAdmin.registerOwnerWithThingID = function(thingID, owner, callbacks, accessToken) {
    return root.KiiThingAdmin._registerOwnerWithIdentifier(thingID, owner, callbacks, accessToken);
  };

  KiiThingAdmin.registerOwnerWithVendorThingID = function(vendorThingID, owner, callbacks, accessToken) {
    return root.KiiThingAdmin._registerOwnerWithIdentifier("VENDOR_THING_ID:" + vendorThingID, owner, callbacks, accessToken);
  };

  KiiThingAdmin._registerOwnerWithIdentifier = function(identifier, owner, callbacks, accessToken) {
    return new Promise(function(resolve, reject) {
  ...
  KiiThingAdmin.loadWithVendorThingID = function(vendorThingID, callbacks, adminToken) {
    var thingAdmin;
    thingAdmin = new root.KiiThingAdmin(null, null, vendorThingID, adminToken);
    return thingAdmin.refresh(callbacks);
  };

  KiiThingAdmin.loadWithThingID = function(thingID, callbacks, adminToken) {
    var thingAdmin;
    thingAdmin = new root.KiiThingAdmin(null, thingID, null, adminToken);
    return thingAdmin.refresh(callbacks);
  };

  KiiThingAdmin.prototype._setAuthToken = function(wrapper) {
    return wrapper.setAuthToken(this._adminToken);
  };

  KiiThingAdmin.prototype.pushSubscription = function() {
    return new root.KiiPushSubscriptionAdmin(this, this._adminToken);
  };

  KiiThingAdmin.prototype.bucketWithName = function(bucketName) {
    return new root.KiiBucketAdmin(bucketName, this, this._adminToken);
  };

  KiiThingAdmin.prototype.encryptedBucketWithName = function(bucketName) {
    return new root.KiiEncryptedBucketAdmin(bucketName, this, this._adminToken);
  };

  KiiThingAdmin.prototype.topicWithName = function(topicName) {
    if (typeof topicName !== "string" || topicName === "") {
      throw new root.InvalidArgumentException('topicName should not null or empty');
    }
    return new root.KiiTopicAdmin(this._getHttpURI(), topicName, this._adminToken);
  ...
  KiiThingAdmin.thingWithID = function(thingID, adminToken) {
    var thingAdmin;
    thingAdmin = new root.KiiThingAdmin(null, thingID, null, adminToken);
    return thingAdmin;
  };

  return KiiThingAdmin;

})(root.KiiThing);

root.KiiTopicAdmin = (function(superClass) {
  extend(KiiTopicAdmin, superClass);

  function KiiTopicAdmin(parentUri, topicName, _adminToken) {
    this._adminToken = _adminToken;
    this.acl = bind(this.acl, this);
    this._setAuthToken = bind(this._setAuthToken, this);
    KiiTopicAdmin.__super__.constructor.call(this, parentUri, topicName);
  }

  KiiTopicAdmin.prototype._setAuthToken = function(wrapper) {
    return wrapper.setAuthToken(this._adminToken);
  };

  KiiTopicAdmin.prototype.acl = function() {
    return new root.KiiACLAdmin(this, this._adminToken);
  };

  return KiiTopicAdmin;

})(root.KiiTopic);

root.KiiPushSubscriptionAdmin = (function(superClass) {
  extend(KiiPushSubscriptionAdmin, superClass);

  function KiiPushSubscriptionAdmin(subscriber, _adminToken) {
    this._adminToken = _adminToken;
    this._setAuthToken = bind(this._setAuthToken, this);
    KiiPushSubscriptionAdmin.__super__.constructor.call(this, subscriber);
  }

  KiiPushSubscriptionAdmin.prototype._setAuthToken = function(wrapper) {
    return wrapper.setAuthToken(this._adminToken);
  };

  return KiiPushSubscriptionAdmin;
...
KiiAnalyticsXHRWrapper = (function(superClass) {
  extend(KiiAnalyticsXHRWrapper, superClass);
...
KiiAnalyticsJQXHRWrapper = (function(superClass) {
  extend(KiiAnalyticsJQXHRWrapper, superClass);
...
KiiAnalyticsTiXHRWrapper = (function(superClass) {
  extend(KiiAnalyticsTiXHRWrapper, superClass);
...
root.KiiSCNGoogle = (function(superClass) {
  extend(KiiSCNGoogle, superClass);
...
root.KiiSCNRenRen = (function(superClass) {
  extend(KiiSCNRenRen, superClass);
